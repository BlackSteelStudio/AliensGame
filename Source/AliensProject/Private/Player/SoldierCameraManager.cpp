...
ASoldierCameraManager::ASoldierCameraManager(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	NormalFOV = 90.0f;
	TargetingFOV = 60.0f;
	ViewPitchMin = -87.0f;
...
void ASoldierCameraManager::UpdateCamera(float DeltaTime)
{
